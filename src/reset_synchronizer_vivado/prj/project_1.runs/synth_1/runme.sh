...
HD_PWD='/tp/xpiese5/xpiese5002/projet_fpga/reset_synchronizer_vivado/prj/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_synchronizer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_synchronizer_top.tcl
