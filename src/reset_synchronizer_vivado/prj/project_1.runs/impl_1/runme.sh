...
HD_PWD='/tp/xpiese5/xpiese5002/projet_fpga/reset_synchronizer_vivado/prj/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_synchronizer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reset_synchronizer_top.tcl -notrace
