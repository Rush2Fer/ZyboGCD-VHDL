...
HD_PWD='/tp/xpiese5/xpiese5002/projet_fpga/signal_synchronizer_vivado/prj/signal_synchronizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_synchronizer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signal_synchronizer_top.tcl
