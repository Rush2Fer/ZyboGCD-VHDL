...
HD_PWD='/tp/xpiese5/xpiese5002/projet_fpga/pgcd_vivado/prj/pgcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pgcd_simple_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pgcd_simple_top.tcl -notrace
